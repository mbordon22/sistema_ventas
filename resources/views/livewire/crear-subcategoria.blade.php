<div class="p-6 bg-white dark:bg-gray-800 dark:text-gray-100">
    <h3 class="py-2 border-b-2 border-b-white text-center font-bold text-lg">Nueva Subcategoria</h3>
    <form method="POST" wire:submit.prevent="crearSubcategoria">
        ...
        <div class="grid grid-cols-2 gap-4 pb-5">
            ...
            <div class="col-span-2">
                ...
                <div class="w-full grid grid-cols-4 items-center gap-4">
                    ...
                    <div class="col-span-1">
                        <input type="checkbox" id="color" wire:model="color">
                    </div>
                </div>
            ...
            <div class="col-span-2">
                <div class="w-full grid grid-cols-4 items-center gap-4">
                    ...
                    <div class="col-span-1">
                        <input type="checkbox" id="talle" wire:model="talle">
                    </div>
                </div>
