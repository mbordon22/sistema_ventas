<div class="p-6 bg-white dark:bg-gray-800 dark:text-gray-100">
    <form method="POST" wire:submit.prevent="editarAlmacen">

        <div class="grid grid-cols-2 gap-4">
            <!-- Nombre -->
            <div class="col-span-1">
                <x-input-label for="nombre" :value="__('Nombre')" />
                <x-text-input id="nombre" class="block mt-1 w-full" type="text" wire:model="nombre" required autofocus />
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="telefono" class="block mt-1 w-full" type="text" wire:model="telefono" required />
        ...
        <div class="mt-4 grid grid-cols-2 gap-4">
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="contacto_nombre" class="block mt-1 w-full" type="text" wire:model="contacto_nombre" required />
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="contacto_email" class="block mt-1 w-full" type="email" wire:model="contacto_email" required />
        ...
        <div class="mt-4 grid grid-cols-2 gap-4">
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="ubicacion" class="block mt-1 w-full" type="text" wire:model="ubicacion" required />
            ...
            <div class="col-span-1">
                ...
                <select wire:model="tipo" id="tipo" required class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
